...
const ContactUsSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col p-6 lg:flex-row lg:justify-between lg:items-center w-full  max-w-[1300px]">
        <motion.div
        ...
        >
          <motion.h3
            className="pt-20 text-4xl md:text-4xl font-semibold mb-4"
